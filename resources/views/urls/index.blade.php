<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <h1 class="text-2xl lg:text-44px font-bold text-blue-500 text-center mb-4" font-poppins">Short URL</h1>
                ...
                <div class="flex-1 w-[100%]">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center font-serif">
                            <span class="text-indigo-600 bg-gray-100 px-2 py-1 rounded-sm text-lg font-bold font-poppins">{{ $item->user->name }}</span>
                            <small class="ml-2 text-sm text-gray-500 font-poppins">{{ $item->created_at->format('j M Y, g:i a') }}</small>
                    ...
                    <p class="mt-4 text-lg font-bold font-poppins text-gray-900 w-[100%] overflow-auto break-all">{{ __('Short Url: ') }}
